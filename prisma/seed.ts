...
async function main() {
  ...
  const internships = [
    ...
    },
    {
      ...
      isPublic: true,
      studentFeedback:
        "Safran offered an incredible opportunity to work on cutting-edge aerospace technology. The internship was challenging but extremely rewarding, and I gained valuable experience in CFD simulation and aerospace engineering.",
    ...
    },
    {
      ...
      isPublic: true,
      studentFeedback:
        "Total Energies provided an excellent environment to apply my hydraulic engineering knowledge. The internship was challenging and gave me valuable insights into the oil and gas industry.",
    ...
    },
    {
      ...
      isPublic: true,
      studentFeedback:
        "My second internship at Airbus was focused on software quality assurance. I gained valuable experience in automated testing and learned about the strict requirements for avionics software development.",
      studentId: users[0].id,
    },
    {
      ...
      isPublic: true,
      studentFeedback:
        "Dassault Systèmes is at the forefront of 3D modeling and simulation. The internship gave me hands-on experience with industry-leading software and allowed me to work on challenging industrial problems.",
      studentId: users[4].id,
    },
    {
      company: "CNES",
      ...
      isPublic: true,
      studentFeedback:
        "The internship at CNES was a dream come true for someone interested in space technology. I worked on challenging problems in orbital mechanics and gained valuable experience in trajectory optimization.",
      studentId: users[2].id,
    },
    {
      company: "Siemens",
      ...
      isPublic: true,
      studentFeedback:
        "Siemens provided an excellent environment to work on cutting-edge industrial automation technology. The internship was challenging and gave me valuable experience in digital twin development and Industry 4.0 concepts.",
      studentId: users[1].id,
    },
    {
      company: "Naval Group",
      ...
      isPublic: true,
      studentFeedback:
        "The internship at Naval Group was an incredible opportunity to work on advanced naval technology. I gained valuable experience in hydrodynamic simulation and learned about the complex requirements of submarine design.",
      studentId: users[5].id,
    },
  ];
  ...
  const messages = [
    {
      content:
        "Hello, I'm very interested in the internship you did at Airbus. Could you tell me more about the application process and if there might be similar opportunities this year?",
      internshipId: (await prisma.internship.findFirst({
        where: { company: "Airbus", subject: { contains: "machine learning" } },
      }))!.id,
      senderId: users[3].id,
      isRead: true,
    },
    {
      content:
        "Hi, I saw your internship at EDF and it aligns perfectly with my interests. Would you be willing to refer me or provide some tips for applying?",
      internshipId: (await prisma.internship.findFirst({
        where: { company: "EDF" },
      }))!.id,
      senderId: users[1].id,
    ...
    {
      content:
        "I'm interested in the Capgemini internship you did. I have experience with React and Node.js. Would you mind sharing your contact's details or putting in a good word for me?",
      internshipId: (await prisma.internship.findFirst({
